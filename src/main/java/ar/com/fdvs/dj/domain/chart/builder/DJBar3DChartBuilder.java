...
public class DJBar3DChartBuilder extends AbstractChartBuilder<DJBar3DChartBuilder> {
	 ...
	 **/
	public DJBar3DChartBuilder setOperation(CalculationEnum operation) {
	 ...
	 **/
	public DJBar3DChartBuilder setLegendPosition(EdgeEnum legendPosition) {
	 ...
	 **/
	public DJBar3DChartBuilder setTitlePosition(EdgeEnum titlePosition) {
	 ...
	 */
	public DJBar3DChartBuilder setLineStyle(LineStyleEnum lineStyle) {
