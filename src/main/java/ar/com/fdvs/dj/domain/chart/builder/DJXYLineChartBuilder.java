...
public class DJXYLineChartBuilder extends AbstractChartBuilder<DJXYLineChartBuilder> {
	 ...
	 **/
	public DJXYLineChartBuilder setLegendPosition(EdgeEnum legendPosition) {
	 ...
	 **/
	public DJXYLineChartBuilder setTitlePosition(EdgeEnum titlePosition) {
	 ...
	 */
	public DJXYLineChartBuilder setLineStyle(LineStyleEnum lineStyle) {
