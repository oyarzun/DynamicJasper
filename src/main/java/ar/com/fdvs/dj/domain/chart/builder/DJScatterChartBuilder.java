...
public class DJScatterChartBuilder extends AbstractChartBuilder<DJScatterChartBuilder> {
	 ...
	 **/
	public DJScatterChartBuilder setOperation(CalculationEnum operation) {
	 ...
	 **/
	public DJScatterChartBuilder setLegendPosition(EdgeEnum legendPosition) {
	 ...
	 **/
	public DJScatterChartBuilder setTitlePosition(EdgeEnum titlePosition) {
