...
public class DJAreaChartBuilder extends AbstractChartBuilder<DJAreaChartBuilder> {
	 ...
	 **/
	public DJAreaChartBuilder setOperation(CalculationEnum operation) {
	 ...
	 **/
	public DJAreaChartBuilder setLegendPosition(EdgeEnum legendPosition) {
	 ...
	 **/
	public DJAreaChartBuilder setTitlePosition(EdgeEnum titlePosition) {
	 ...
	 */
	public DJAreaChartBuilder setLineStyle(LineStyleEnum lineStyle) {
